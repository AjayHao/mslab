package com.ajayhao.simpleboot.test.reflect;

import com.ajayhao.simpleboot.demos.classloader.MyClassLoader;
...
public class TestClassLoader {
    ...
    public void testLoadClass() throws IOException{
        ...
        Assert.assertEquals(clazz.getCanonicalName(), "com.ajayhao.simpleboot.demos.PersonVO");
    }
}
