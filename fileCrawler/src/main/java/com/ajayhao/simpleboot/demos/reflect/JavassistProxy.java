...
public class JavassistProxy {
    ...
    public Object getProxy(){
        ...
        CtClass ctClass = pool.makeClass("com.ajayhao.simpleboot.demos.reflect.PersonServiceJavaassistProxy");

        Object proxy = null;

        try {
            //设置接口
            CtClass personServiceInterface = pool.get("com.ajayhao.simpleboot.demos.reflect.PersonService");
            ...
            CtClass personVOClass = pool.get("com.ajayhao.simpleboot.demos.PersonVO");
            ...
            body.append("{\n ")
                        .append("$0.id = $1; \n")
                        .append("$0.name = $2 + \"哈哈哈\"; \n")
                        .append("return new com.ajayhao.simpleboot.demos.PersonVO($0.id, $0.name);").append("\n}");
